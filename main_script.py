...
if __name__ == '__main__':
    while True:
        ...
        try:
            ...
            print(traceback.format_exc())
        try:
            print('Start clinical_trials_uploader')
